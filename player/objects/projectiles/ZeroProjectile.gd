# player/projectiles/ZeroProjectile.gd
extends Area2D

var direction: Vector2 = Vector2.RIGHT
var speed: float       = 600.0
var level: int         = 0    # 0=lv1, 1=lv2
var is_alt: bool       = false

@onready var sprite: AnimatedSprite2D = $Sprite

const ANIM_PATHS: Array[String] = [
	"res://resources/animations/spr_zero_shot_lv1.tres",
	"res://resources/animations/spr_zero_shot_lv2.tres",
]
